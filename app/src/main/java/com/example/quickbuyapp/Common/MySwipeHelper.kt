...
abstract class MySwipeHelper(context: Context,
    ...
    private val buttonBuffer:MutableMap<Int,List<MyButton>>
    ...
    override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
        ...
        if(buttonBuffer.containsKey(swipePosition))
            buttonList= buttonBuffer [swipePosition] as MutableList<MyButton>?
        else
            buttonList!!.clear()
        buttonBuffer.clear()
        ...
        if(actionState==ItemTouchHelper.ACTION_STATE_SWIPE){
            if(dX<0){
                ...
                if(!buttonBuffer.containsKey(pos))
                {
                    ...
                    buffer= (buttonBuffer[pos] as MutableList<MyButton>?)!!
